...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <ul class="nospace group btmspace-80">
      <li class="one_third first">
        <article class="service"><i class="icon fa fa-ambulance"></i>
          <h6 class="heading"><a href="#">맛집 Top 1</a></h6>
      ...
      <li class="one_third">
        <article class="service"><i class="icon fa fa-h-square"></i>
          <h6 class="heading"><a href="#">레시피 Top 1</a></h6>
          <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet.</p>
          <footer><a href="#">Read More &raquo;</a></footer>
        </article>
      </li>
      <li class="one_third">
        <article class="service"><i class="icon fa fa-hospital-o"></i>
          <h6 class="heading"><a href="#">쉐프 Top 1</a></h6>
          <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet.</p>
          <footer><a href="#">Read More &raquo;</a></footer>
        </article>
      </li>
    ...
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
        <c:forEach var="rvo" items="${recipeList }">
        <li>
          <figure><img class="radius-10 btmspace-10" src="${rvo.poster }" style="width: 320px;height: 185px">
            <figcaption><a href="#">${ rvo.title}</a></figcaption>
          </figure>
        </li>
       </c:forEach>
      </ul>
    ...
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
       <c:forEach var="cvo" items="${chefList }">
        <li>
          <figure><img class="radius-10 btmspace-10" src="${cvo.poster }" style="width: 320px;height: 185px">
            <figcaption><a href="#">${ cvo.chef}</a></figcaption>
          </figure>
        </li>
       </c:forEach>
      </ul>
        ...
        <li>
          <figure>
          	<a href="../food/food_list_detail.do?fno=${vo.fno }">
          		<img class="radius-10 btmspace-10" src="http://www.menupan.com${vo.poster }" style="width: 320px;height: 185px">
          	</a>
            	<figcaption><a href="../food/food_list_detail.do?fno=${vo.fno }">${vo.name }</a></figcaption>
          </figure>
        </li>
       </c:forEach>
      </ul>
