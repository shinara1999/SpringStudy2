      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            ...
            <li v-for="(vo, index) in food_list" :class="index%4==0?'one_quarter first':'one_quarter'"><img class="img_click" :src="'https://www.menupan.com'+vo.poster" :title="vo.name" @click="detail(vo.fno)"></li>
...
<script>
 const detailComponent={
		 props:['food_detail'], // props : properties
			...
			*/	
			axios.get('../food/detail_vue.do',{
				...
				this.food_detail=response.data
					...
					$('#dialog').dialog({
					autoOpen:false,
					modal:true, // dialog창 제어가 끝나야 다른거 제어 가능
					width:700,
					height:600
				}).dialog("open")
