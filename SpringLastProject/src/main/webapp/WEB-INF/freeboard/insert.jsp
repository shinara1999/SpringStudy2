  	...
  	<table class="table">
  		...
  		<tr>
  			<td colspan="2" class="text-center inline">
  				<input type="button" value="글쓰기" class="btn btn-sm btn-info" @click="write()">
 ...
 let fApp=Vue.createApp({
	 ...
	 methods:{
		 write(){
			 ...
			 axios.post('../freeboard/insert_vue.do', null, { // post방식은 꼭 두번째값은 null 값을 주고 세번째 값에서 데이터를 보내준다.
				 params:{
					 name:this.name,
