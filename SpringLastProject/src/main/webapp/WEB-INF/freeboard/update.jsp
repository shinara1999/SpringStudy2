  	...
  	<table class="table">
  		...
  		<tr>
  			<td colspan="2" class="text-center inline">
  				<input type="button" value="수정하기" class="btn btn-sm btn-info" @click="update()">
  				<input type="button" value="취소" class="btn btn-sm btn-danger" onclick="javascript:history.back()" @click="goback">
  			</td>
  		</tr>
  	</table>
  </main>
