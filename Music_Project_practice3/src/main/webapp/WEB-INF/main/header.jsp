                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="../resources/views/property-list.html" class="dropdown-item">Property List</a>
                                <a href="../resources/views/property-type.html" class="dropdown-item">Property Type</a>
                                <a href="../resources/views/property-agent.html" class="dropdown-item">Property Agent</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
